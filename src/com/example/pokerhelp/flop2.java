...
public class flop2 extends Activity{
	Button clubs2;
	Button clubs3;
	Button clubs4;
	Button clubs5;
	...
	protected void onCreate(Bundle savedInstanceState) {
	      ...
	      clubs2.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(2,2);HeadsUp.cambiarf2(R.drawable.cardclubs2);
	    		  //HeadsUp.F2 = new carta(3,);HeadsUp.cambiarf2(R.drawable.cardclubs2);
	    		  finish();
	      ...
	      clubs3.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(2,3);HeadsUp.cambiarf2(R.drawable.cardclubs3);
	    		  
	    		  //HeadsUp.F2 = new carta(3,);HeadsUp.cambiarf2(R.drawable.cardclubs3);
	      ...
	      clubs4.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(2,4);HeadsUp.cambiarf2(R.drawable.cardclubs4);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      clubs5.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(2,5);HeadsUp.cambiarf2(R.drawable.cardclubs5);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      clubs6.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(2,6);HeadsUp.cambiarf2(R.drawable.cardclubs6);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      clubs7.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(2,7);HeadsUp.cambiarf2(R.drawable.cardclubs7);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      clubs8.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(2,8);HeadsUp.cambiarf2(R.drawable.cardclubs8);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      clubs9.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(2,9);HeadsUp.cambiarf2(R.drawable.cardclubs9);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      clubs10.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(2,10);HeadsUp.cambiarf2(R.drawable.cardclubs10);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      clubsj.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(2,11);HeadsUp.cambiarf2(R.drawable.cardclubsj);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      clubsq.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(2,12);HeadsUp.cambiarf2(R.drawable.cardclubsq);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      clubsk.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(2,13);HeadsUp.cambiarf2(R.drawable.cardclubsk);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      clubsa.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(2,14);HeadsUp.cambiarf2(R.drawable.cardclubsa);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      diamonds2.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(4,2);HeadsUp.cambiarf2(R.drawable.carddiamonds2);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      diamonds3.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(4,3);HeadsUp.cambiarf2(R.drawable.carddiamonds3);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      diamonds4.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(4,4);HeadsUp.cambiarf2(R.drawable.carddiamonds4);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      diamonds5.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(4,5);HeadsUp.cambiarf2(R.drawable.carddiamonds5);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      diamonds6.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(4,6);HeadsUp.cambiarf2(R.drawable.carddiamonds6);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      diamonds7.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(4,7);HeadsUp.cambiarf2(R.drawable.carddiamonds7);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      diamonds8.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(4,8);HeadsUp.cambiarf2(R.drawable.carddiamonds8);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      diamonds9.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(4,9);HeadsUp.cambiarf2(R.drawable.carddiamonds9);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      diamonds10.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(4,10);HeadsUp.cambiarf2(R.drawable.carddiamonds10);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      diamondsj.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(4,11);HeadsUp.cambiarf2(R.drawable.carddiamondsj);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      diamondsq.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(4,12);HeadsUp.cambiarf2(R.drawable.carddiamondsq);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      diamondsk.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(4,13);HeadsUp.cambiarf2(R.drawable.carddiamondsk);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      diamondsa.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(4,14);HeadsUp.cambiarf2(R.drawable.carddiamondsa);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      spades2.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(1,2);HeadsUp.cambiarf2(R.drawable.cardspades2);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      spades3.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(1,3);HeadsUp.cambiarf2(R.drawable.cardspades3);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      spades4.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(1,4);HeadsUp.cambiarf2(R.drawable.cardspades4);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      spades5.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(1,5);HeadsUp.cambiarf2(R.drawable.cardspades5);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      spades6.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(1,6);HeadsUp.cambiarf2(R.drawable.cardspades6);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      spades7.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(1,7);HeadsUp.cambiarf2(R.drawable.cardspades7);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      spades8.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(1,8);HeadsUp.cambiarf2(R.drawable.cardspades8);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      spades9.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(1,9);HeadsUp.cambiarf2(R.drawable.cardspades9);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      spades10.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(1,10);HeadsUp.cambiarf2(R.drawable.cardspades10);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      spadesj.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(1,11);HeadsUp.cambiarf2(R.drawable.cardspadesj);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      spadesq.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(1,12);HeadsUp.cambiarf2(R.drawable.cardspadesq);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      spadesk.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(1,13);HeadsUp.cambiarf2(R.drawable.cardspadesk);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      spadesa.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(1,14);HeadsUp.cambiarf2(R.drawable.cardspadesa);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      hearts2.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(3,2);HeadsUp.cambiarf2(R.drawable.cardhearts2);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      hearts3.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(3,3);HeadsUp.cambiarf2(R.drawable.cardhearts3);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      hearts4.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(3,4);HeadsUp.cambiarf2(R.drawable.cardhearts4);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      hearts5.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(3,5);HeadsUp.cambiarf2(R.drawable.cardhearts5);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      hearts6.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(3,6);HeadsUp.cambiarf2(R.drawable.cardhearts6);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      hearts7.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(3,7);HeadsUp.cambiarf2(R.drawable.cardhearts7);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      hearts8.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(3,8);HeadsUp.cambiarf2(R.drawable.cardhearts8);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      hearts9.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(3,9);HeadsUp.cambiarf2(R.drawable.cardhearts9);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      hearts10.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(3,10);HeadsUp.cambiarf2(R.drawable.cardhearts10);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      heartsj.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(3,11);HeadsUp.cambiarf2(R.drawable.cardheartsj);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      heartsq.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(3,12);HeadsUp.cambiarf2(R.drawable.cardheartsq);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      heartsk.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(3,13);HeadsUp.cambiarf2(R.drawable.cardheartsk);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
	      ...
	      heartsa.setOnClickListener(new Button.OnClickListener(){
	    	  ...
	    	  public void onClick(View arg0) {
	    		  ...
	    		  HeadsUp.F2 = new carta(3,14);HeadsUp.cambiarf2(R.drawable.cardheartsa);
	    		  finish();//Intent i = new Intent(getApplicationContext(), HeadsUp.class); startActivity(i); overridePendingTransition(R.anim.fadein, R.anim.fadeout);
